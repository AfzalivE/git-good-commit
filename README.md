...
```sh
curl https://raw.githubusercontent.com/AfzalivE/git-good-commit/master/hook.sh > .git/hooks/commit-msg && chmod +x .git/hooks/commit-msg
```
...
curl https://raw.githubusercontent.com/AfzalivE/git-good-commit/master/hook.sh > ~/.git-template/hooks/commit-msg && chmod +x ~/.git-template/hooks/commit-msg
```
